...
│   └── use_case_example_1/                         # Example energy processing pipeline
...
**Usage**:
```bash
python orchestrator/scripts/onboarding-export-generator.py use-cases/use_case_example_1 orchestrator/use-cases-platform/example-1 --overwrite
```
...
cd use-cases/use_case_example_1
...
**Arguments**:
- `use_case_dir`: Path to use case directory (e.g., `use-cases/use_case_example_1`)
